...
class TWW_CanMembershipShortcode extends TWW_Shortcodes {
    ...
    protected function set_sc_settings() {
        $this->sc_settings = [
            'name' => 'can_current_membership', 
            'css_handle' => 'tww-can-membership-shortcode',
            'handle' => 'tww-can-membership-shortcode',
    ...
    public function render_shortcode($atts, $content = null) {
        ...
        ob_start();
        include TWW_FORMS_PLUGIN . 'templates/can-current-membership-shortcode.php';
        return ob_get_clean();
    }
