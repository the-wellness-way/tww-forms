...
use TWWForms\Includes\TWW_MeprProductsHelper;

  if(!defined('ABSPATH')) {die('You are not allowed to call this page directly.');}
  $mepr_options = MeprOptions::fetch();

  if(file_exists(TWW_FORMS_PLUGIN . 'src/Includes/TWW_MeprProductsHelper.php')) {
    require_once TWW_FORMS_PLUGIN . 'src/Includes/TWW_MeprProductsHelper.php';
  }
...
<div id="mepr-products-form" class="inside">
  ...
  */ ?>
  ...
  <div id="mepr-recurring-options" class="mepr-hidden">
    ...
    <p>
      <?php echo TWW_MeprProductsHelper::preset_period_dropdown( MeprProduct::$period_str,
